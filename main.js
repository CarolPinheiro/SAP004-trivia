...
if (desejaJogar == 1) {
    ...
    if (primeiraPergunta === 1){
        ...
        respostaCorreta1.innerHTML = "Você acertou a questão 1";
    ...
    if (segundaPergunta === 3){
        let respostaCorreta2 = document.getElementById("resposta-correta-2");
        respostaCorreta2.innerHTML = "Você acertou a questão 2";
        
    } else {
         let respostaErrada2 = document.getElementById("resposta-errada-2");
    ...
    if (terceiraPergunta === 2){
        let respostaCorreta3 = document.getElementById("resposta-correta-3");
        respostaCorreta3.innerHTML = "Você acertou a questão 3";
        
    } else {
         let respostaErrada3 = document.getElementById("resposta-errada-3");
